...
/**
 * Theme_gitam install function.
 *
 * @return void
 */

function xmldb_theme_gitam_install() {
    global $CFG;
    ...
    // Slider images.
        ...
        $filerecord->component = 'theme_gitam';
        ...
        $fs->create_file_from_pathname($filerecord, $CFG->dirroot . '/theme/gitam/pix/home/slide1.jpg');
}
